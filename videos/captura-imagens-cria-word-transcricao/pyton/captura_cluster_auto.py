...
video_name = input("Digite o nome do arquivo de vídeo (ex: Video-003.mp4): ").strip()
VIDEO = os.path.join(BASE, video_name)

# Retira a extensão da pasta com os frames
folder_name = os.path.splitext(video_name)[0]
result_folder = f"Imagens_{folder_name}"
PASTA = os.path.join(BASE, result_folder)
...
print("Veja 'cluster_report.csv' para agrupamento!")
