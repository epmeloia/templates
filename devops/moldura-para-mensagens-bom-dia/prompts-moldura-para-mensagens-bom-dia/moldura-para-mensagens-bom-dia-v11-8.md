# 📅🎨 Moldura para Mensagens de Bom Dia - v11.8

Arquivo: "moldura-para-mensagens-bom-dia-v11-8.md"
...
* Toda cena deve incluir **pelo menos três personagens claramente visíveis**.  
* Personagens nunca devem ser humanos realistas; o foco são bonecos, robôs, mascotes ou objetos levemente humanizados.  

* Personagens podem ser, por exemplo:  
  * checklists, cartões de tarefa, post-its  
  * lupas, relógios, ampulhetas, bússolas  
  * notebooks, teclados, monitores, tablets  
  * pequenos robôs, mascotes digitais, ícones, engrenagens  
  * cadernos, blocos de notas, canetas, marcadores, caixas  

* Esses elementos devem ter **antropomorfismo leve**:  
  * rostos simples (olhos, boca)  
  * expressões suaves (curioso, concentrado, tranquilo, satisfeito)  
  * postura ou gesto que sugira ação (observando, revisando, guiando, apontando, descansando de forma consciente).  

* É proibido:  
  * usar humanos realistas como foco principal  
  * usar figuras humanas com traços realistas de rosto e corpo  
  * É obrigatório gerar cenas sempre com personagens

* A quantidade de personagens pode variar (três ou vários), mas **sempre** deve haver pelo menos três elementos com "vida" explícita.  

* O personagem ou personagens devem sempre apoiar a mensagem da frase (revisão, clareza, descanso consciente, organização, foco, etc.), nunca competir com o texto nem desviar o sentido central.
...
* Versão: v11.8
* Data de criação / última revisão: consolidado até 2026-03-16
