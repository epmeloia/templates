...
class TemperatureMonitorApp:
    ...
    def _build_layout(self) -> None:
        ...
        temperature_panel.pack(anchor="center", fill="x", pady=(18, 0))
        ...
        status_panel.pack(anchor="center", fill="x", pady=(14, 0))
    ...
    def _add_temperature_card(
        ...
        card = tk.Frame(parent, bg=COLOR_PANEL, padx=8, pady=4)
