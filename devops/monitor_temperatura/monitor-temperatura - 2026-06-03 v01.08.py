...
class TemperatureMonitorApp:
    ...
    def _build_layout(self) -> None:
        main = tk.Frame(self.root, bg=COLOR_BACKGROUND, padx=26, pady=22)
        ...
        self.temperature_label.pack(anchor="center", pady=(10, 2))
        ...
        details.pack(anchor="center", fill="x", pady=(18, 0))

        self.max_temperature_label = self._add_metric_row(
            details, "Nucleo maximo", self.max_temperature_var, 0
        )
        self.package_temperature_label = self._add_metric_row(
            details, "CPU Inteira", self.package_temperature_var, 1
        )
        self._add_metric_row(details, "Estrangulamento termico", self.thermal_throttling_var, 2)
        self._add_metric_row(details, "Limite de potencia", self.power_limit_var, 3)
